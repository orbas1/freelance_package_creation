    ...
    public function sendImages($request, $message)
    {
        if($request->hasFile('media')){
            ...
            foreach($request->file('media') as $media){
                ...
                $media->storeAs('public/laraguppy/images/', $photoName);
                $media->storeAs('public/laraguppy/images/', $photoThumbnaiName);
    ...
    public function sendVideos($request, $message)
    {
        if($request->hasFile('media')){
            ...
            foreach($request->file('media') as $media){
                ...
                $media->storeAs('public/laraguppy/videos/', $videoName);
    ...
    public function sendDocuments($request, $message)
    {
        if($request->hasFile('media')){
            ...
            foreach($request->file('media') as $media){
                ...
                $media->storeAs('public/laraguppy/documents/', $documentName);
    ...
    public function sendAudios($request, $message)
    {
        if($request->hasFile('media')){
            ...
            foreach($request->file('media') as $media){
                ...
                $media->storeAs('public/laraguppy/audio/', $audioName);
    ...
    public function sendVoice($request, $message)
    {
        if($request->hasFile('media')){
            ...
            foreach($request->file('media') as $media){
                ...
                $media->storeAs('public/laraguppy/voice/', $voiceName);
                $voices = [
