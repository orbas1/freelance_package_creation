...
namespace Amentotech\LaraPayEase\Drivers;

use Amentotech\LaraPayEase\BasePaymentDriver;
use Amentotech\LaraPayEase\Traits\Currency;
...
class Stripe extends BasePaymentDriver
{
    ...
    public function chargeCustomer(array $params){
        ...
        return view('payease::stripe', ['stripe_data' => array_merge($params,[
