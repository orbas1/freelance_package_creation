...
class DatabaseController extends Controller
{
    public $seederGroups = [
        ...
        'general' => [
            ...
            \Database\Seeders\DefaultGigs::class,
            \Database\Seeders\DefaultProjects::class,
            \Database\Seeders\PackagesSeeder::class,
            \Database\Seeders\TaxonomiesSeeder::class,
        ],
        'pages' => [
            \Database\Seeders\DefaultSettingSeeder::class,
            \Database\Seeders\DefaultPageSettingSeeder::class,
            \Database\Seeders\EmailTemplates::class,
        ],
        'users' => [
            \Database\Seeders\DefaultAccounts::class,
        ],
    ];
    /**
     * @var DatabaseManager
