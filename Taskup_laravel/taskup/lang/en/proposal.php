...
return [
    ...
    */
    ...
    'already_submitted_msg'                     => "Proposal already submitted",
    ...
    'price_error'                               => 'Milestone\'s total price should be equal to the budget working rate',
    'hourly_error'                              => 'The payout type should be hourly for this project type',
    'fixed_error'                               => 'The payout type should be fixed or milestone for this project type',
];
