            ...
            <div class="tk-project-box tk-project-boxvtwo">
                ...
                <div class="tk-attachments-hodler" id="gig-plans">
                    @if(count($gig_plans) < 3)
                        <a class="tk-add-more mb-2" href="javascript:;" wire:click.prevent="addNewPlan"><h6>{{ __('gig.add_new')}} </h6><i class="icon-plus"></i></a>
                    @endif
                            ...
                            <div class="tk-attechment-tittle">
                                ...
                                <div class="tk-accord-rightside">
                                    <div class="tk-switchbtn">
                                        <label for="is-featured-{{$key}}" wire:key="is-featured-{{$key}}-{{time()}}" class="tk-textdes"><span id="tk-textdes">{{ __('gig.featured')}}</span></label>
                                ...
                                <form class="tk-themeform">
                                    <fieldset>
                                        <div class="tk-themeform__wrap">
                                            ...
                                            @if( count($gig_plans) > 1 )
                                                <div class="form-group">
                                                    <a class="tk-Remove-adon" href="javascript:;" wire:click.prevent="removePlan({{ $key }})"><i class="icon-trash-2"></i><span>{{ __('gig.remove_plan')}}</span></a>
                                                </div>
                                            @endif
                                        </div>
                                    </fieldset>
