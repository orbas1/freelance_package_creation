                    ...
                    <form class="tb-themeform tb-displistform">
                        <fieldset>
                            <div class="tb-themeform__wrap">
                                ...
                                <div class="tb-actionselect">
                                    <div class="tb-select">
                                        <select wire:model="per_page" class="form-control tk-select2">
                        ...
                        <tbody>
                            @foreach($users as $single)
                                ...
                                <tr>
                                    ...
                                    <td data-label="{{__('general.status')}}" onClick="deleteUser({{ $single->id }}, '{{ $single->status }}')">
...
<script>
    ...
    function deleteUser( id, status ){
        ...
        let content         = status == 'activated' ? '{{ __("general.deactivate_user_acc") }}' : '{{ __("general.activate_user_acc") }}';
