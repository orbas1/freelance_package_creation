    ...
    <div class="row">
                                        ...
                                        <ul class="tb-uploadbar">
                                            ...
                                            @if (!empty($package['image']) && method_exists($package['image'],'temporaryUrl'))
                                                <div wire:loading.remove class="tb-uploadel tb-upload-two">
                                                    ...
                                                    <span>{{$package['image']->getClientOriginalName()}} <a href="javascript:void(0);" wire:click.prevent="removeImage"> <i class="icon-trash-2"></i></a> </span>
                                                </div>
                                            @elseif(!empty($old_image))
                                                ...
                                                <div wire:loading.remove class="tb-uploadel tb-upload-two">
                                                    ...
                                                    <span>{{ $image_name }}<a href="javascript:void(0);" wire:click.prevent="removeImage"> <i class="icon-trash-2"></i></a></span>
                                                </div>
                                            @endif
                                        </ul>
        ...
        <div class="col-xl-8">
                        ...
                        <fieldset>
                            <div class="tb-themeform__wrap">
                                <div class="tb-actionselect">
                                    <div class="tb-select">
                                        <select wire:model="sortby" class="form-control tk-select2">
                                ...
                                <div class="tb-actionselect">
                                    <div class="tb-select">
                                        <select wire:model="per_page" id="tb-selection1" class="form-control tk-select2">
            ...
            <div class="tb-dbholder border-0 tb-todolist">
                ...
                <table class="table tb-table tb-dbholder tb-packages-table p-0">
                    <thead>
                        <tr>
