...
<div class="tk-paymentways">
    ...
    <div class="tk-dbbox">
        ...
        <ul class="tk-payoutmethod tk-payoutmethodvtwo" id="tk-payment-accordion">
            @if( $method_type == 'escrow' )
                ...
                <div id="tk-escrow" wire:ignore.self class="collapse tb-stepescrow" data-bs-parent="#tk-payment-accordion">
            ...
            @elseif($method_type == 'others')
                ...
                <div id="tk-paypal" wire:ignore.self class="collapse tb-stepescrow" data-bs-parent="#tk-payment-accordion">
                    <form class="tk-themeform tk-payment-submenu">
                        <fieldset>
                            <div class="tk-themeform__wrap">
                                <div class="form-group">
                ...
                <div id="tk-payoneer" wire:ignore.self class="collapse tb-stepescrow" data-bs-parent="#tk-payment-accordion">
                    <form class="tk-themeform tk-payment-submenu">
                        <fieldset>
                            <div class="tk-themeform__wrap">
                                <div class="form-group">
                ...
                <div id="tk-bank" wire:ignore.self class="collapse tb-stepescrow" data-bs-parent="#tk-payment-accordion">
                    <form class="tk-themeform tk-payment-submenu">
                        <fieldset>
                            <div class="tk-themeform__wrap">
                                <div class="form-group">
