<main class="tk-scetiondb">
    <section wire:target="keyword" wire:loading.class="tk-section-preloader" >
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12" data-select2-id="9">
                    <div class="tk-dhb-mainheading" data-select2-id="8">
                ...
                <div class="col-xl-12">
                    ...
                    @if( !$items->isEmpty() )
                        ...
                        @foreach($items as $single)
                            ...
                            @elseif( $filter_by == 'gig' )
                                <x-gig-item :gig="$item" :user_role="'buyer'" :address_format="$address_format" :currency_symbol="$currency_symbol" :is_save_item="true"/>
                            @elseif( $filter_by == 'profile' )
