<div class="col-lg-8 col-xl-9" wire:key="profile-settings">
					...
					<div wire:ignore class="tk-freelancer-content-two">
						...
						<div class="tk-uploadbtnpic">
							<div class="tk-uploadbtn">
								<label for="upload_image" class="tk-btn tk-btnsmall">
							...
							<a href="javascript:void(0);" wire:click.prevent="removePhoto" class="tk-btn tk-btnsmall tk-btnlight">{{__('settings.remove')}}</a>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="tk-employerproject-title">
					<div class="tk-uploadprofilepic">
						...
						<div class="tk-freelancer-content-two">
							...
							<div class="tk-uploadbtnpic">
								<div class="tk-uploadbtn">
									<label for="upload_banner" class="tk-btn tk-btnsmall">
								...
								@if( ( !empty($banner) && method_exists($banner,'temporaryUrl') ) || !empty($old_banner) )
									<a href="javascript:void(0);" wire:click.prevent="removeBanner" class="tk-btn tk-btnsmall tk-btnlight">{{__('settings.remove')}}</a>
								@endif
							</div>
						</div>
					</div>
	...
	@if($userRole == 'seller' )
		<!-- education list -->
		<div class="tk-project-wrapper tk-edudeatilwrap">
			<div class="tk-project-box p-0">
